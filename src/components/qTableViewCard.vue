          ...
          <q-list dense>
            <q-item v-for="col in props.cols.filter(col => col.name !== 'desc')" :key="col.name">
              ...
              <template v-if="col.name === 'Actions/Status'">
                <q-item-section side>
                  <template v-if="cancelLeave ? (props.row.approvedByLevel1 !== null && props.row.status === 'PendingLevel2') || (props.row.approvedByLevel2 !== null && props.row.status === 'Approved') : (props.row.cancelledByLevel1 !== null && props.row.cancelledStatusOrig === 'PendingLevel2') || (props.row.cancelledByLevel2 !== null && props.row.cancelledStatusOrig === 'Approved')">
